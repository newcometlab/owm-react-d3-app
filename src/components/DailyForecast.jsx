    ...
    return (
        <div className="table-container">
          ...
          <table className="table_box">
            ...
            <tr>
              <td><i className={`wi ${getIcon(forecastList[0].icon)}`}></i></td>
              <td>Today</td>
            ...
            <tr>
              <td><i className={`wi ${getIcon(forecastList[1].icon)}`}></i></td>
            ...
            <tr>
              <td><i className={`wi ${getIcon(forecastList[2].icon)}`}></i></td>
            ...
            <tr>
              <td><i className={`wi ${getIcon(forecastList[3].icon)}`}></i></td>
            ...
            <tr>
              <td><i className={`wi ${getIcon(forecastList[4].icon)}`}></i></td>
